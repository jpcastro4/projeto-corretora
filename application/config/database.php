...
if( $_SERVER['HTTP_HOST'] == 'localhost'){ 
...
}elseif( $_SERVER['HTTP_HOST'] == '192.168.1.10'){
	...
	// $db['default']['hostname'] = 'localhost';//'grupoelloinvestimentos.com.mysql';
	// $db['default']['username'] = 'redeads5_user';//'grupoelloinvestimentos_com';'grupoellouser';
	// $db['default']['password'] = '1P7RB{tpt~^c';//'997110';'RHw5nk9B9Tx?';
	// $db['default']['database'] = 'redeads5_clone';
	$db['default']['hostname'] = 'localhost';//'grupoelloinvestimentos.com.mysql';
