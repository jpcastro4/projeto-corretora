...
require_once('ChallengeSMS.php');
require_once('Checkpoint.php');
require_once('InstagramException.php');
require_once('InstagramRegistration.php');
require_once('SignatureUtils.php');
require_once('Constants.php');

require_once('Utils/AutoResponseFunctionSetter.php');
require_once('Utils/SettingsAdapter.php');
require_once('Utils/SettingsFile.php');
require_once('Utils/SettingsMysql.php');
require_once('Utils/AdaptImage.php');
require_once('Utils/Debug.php');

require_once('http/UserAgent.php');
require_once('http/HttpInterface.php');
require_once('http/Response/Response.php');
require_once('http/Response/SyncResponse.php');
