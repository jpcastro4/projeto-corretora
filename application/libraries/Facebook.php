...
Class Facebook
{
    ...
    {
        return $this->native_session->get('fb_access_token');
    }
    ...
    {
        $this->native_session->set('fb_access_token', $access_token->getValue());
    }
    ...
    {
        return $this->native_session->get('fb_expire');
    }
    ...
    {
        if ($time) {
            $this->native_session->set('fb_expire', $time->getTimestamp());
        }
    }
