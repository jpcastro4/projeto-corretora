        ...
        <div class='col-lg-12'>
          <form class="form-login" action="" method="post">
            ...
            <fieldset class='text-center'>
              <legend>Esqueceu a senha da sua Conta Master?</legend>
                  <div class="form-group">
                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Seu e-mail" name="email" required/>
                  </div>
                  <div class="form-actions row">
                            <button type="button" id="back-btn" class="btn btn-default pull-left" onclick="window.location.href='<?php echo base_url();?>painel/conta-master/login'">Acessar</button>
