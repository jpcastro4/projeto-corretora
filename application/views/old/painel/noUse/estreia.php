	  		...
	  		<div id="showtime"></div>
	  			<div class="col-lg-4 col-lg-offset-4">
	  				...
	  				<div class="lock-screen">
                        ...
                        <h3 style="color:#fff">Parabéns. Seja bem vindo ao Grupo Ello</h3>
		  				<p style="color:#fff">Estamos processando seu cadastro.<br> Em breve você será liberado para compra de ativos. </p>
