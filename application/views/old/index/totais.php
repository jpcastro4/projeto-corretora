          ...
          <div class="card card-inverse card-social">
            ...
            <table class="table">
              ...
              <tbody>
                  ...
                  <tr>
                    <td>Total de cadastrados:</td>
                    <td><?php echo $total_cadastrados; ?></td>
                  </tr>
                  <tr>
                    <td>Aptos que não entraram ainda:</td>
                    <td><?php echo $total_aptos; ?></td>
                  </tr>
                  <tr>
                    <td>Total participando:</td>
                    <td><?php echo $total_participando; ?></td>
                  </tr>
                  <tr>
                    <td>Total de bloqueados:</td>
                    <td><?php echo $bloqueados; ?></td>
                  </tr>

                  <tr style="background:#eee;" ><td> Ciclo 1</td></tr>
                  <tr>
                    <td>Doacoes concluídas:</td>
                    <td><?php echo $doacoes_concluidas; ?></td>
                  </tr>
                  <tr>
                    <td>Doacoes nao Concluidas:</td>
                    <td><?php echo $doacoes_naoconcluidas; ?></td>
                  </tr>
                  <tr>
                    <td>Doacoes aguardando:</td>
                    <td><?php echo $doacoes_aguardando; ?></td>
                  </tr>

                  <tr style="background:#eee;" ><td> Ciclo 2</td></tr>
                  <tr>
                    <td>Fila para o Ciclo 2:</td>
                    <td><?php echo $aptos_ciclo2; ?></td>
                  </tr>
                  <tr>
                    <td>Doações concluidas:</td>
                    <td><?php echo $doacoes_concluidas_ciclo2; ?></td>
                  </tr>

                  <tr>
                    <td>Doações nao concluidas:</td>
                    <td><?php echo $doacoes_aguardando_cilo2; ?></td>
                  </tr>

                  <tr>
                    <td>Doações aguardando:</td>
                    <td><?php echo $doacoes_naoconcluidas_ciclo2; ?></td>
                  </tr>


                  <tr style="background:#eee;" ><td> Ciclo 3</td></tr>
                  <tr>
                    <td>Fila para o Ciclo 3:</td>
                    <td><?php echo $aptos_ciclo3; ?></td>
                  </tr>
                  <tr>
                    <td>Doações concluídas:</td>
                    <td><?php echo $doacoes_concluidas_cilo3; ?></td>
                  </tr>

                  <tr>
                    <td>Doações nao concluidas:</td>
                    <td><?php echo $doacoes_aguardando_cilo3; ?></td>
                  </tr>

                  <tr>
                    <td>Doações aguardando:</td>
                    <td><?php echo $doacoes_naoconcluidas_ciclo3; ?></td>
                  </tr>

                  <tr style="background:#eee;"><td> Reentradas</td></tr>
                  <tr>
                    <td>Reentradas abertas:</td>
                    <td><?php echo $reentradas; ?></td>
                  </tr>
                  <tr>
                    <td>Concluidas:</td>
                    <td><?php echo $reentradas_concluidas; ?></td>
                  </tr>

                  <tr>
                    <td>Nao concluidas:</td>
                    <td><?php echo $reentradas_naoconcluidas; ?></td>
                  </tr>

                  <tr>
                    <td>Aguardando:</td>
                    <td><?php echo $reentradas_aguardando; ?></td>
                  </tr>
