      ...
      <div class="row">     
        ...
        <div class="col-md-8 col-xl-6 col-xl-offset-3">
          ...
          <div class="card card-inverse card-social">
            ...
            <pre>
            <?php //$linhas = $this->backoffice_model->RastreadorAptosCiclo(1) ; 

            //foreach( $linhas as $key => $linha ){

             //echo $key.' - '.count($linha).'</br></br>';

            //} ?>
            </pre>

            <pre><?php //var_dump( $this->backoffice_model->RedeEDAptosCiclo(1) ) ?></pre>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <?php $i = 1; foreach ($aptos_ciclo2 as $apto) : 

                 //$contaUser = $this->backoffice_model->infoUser($apto->idRecebedor)->conta_id;
                  if($apto->total == 5  ):
                ...
                ?>
                  ...
                  <tr>
                  <td><?php echo $i++; ?></td>
                  <td><?php echo $apto->idRecebedor ?> - <?php echo $this->backoffice_model->infoUser($apto->idRecebedor)->conta_id ?></td>
                  <td><?php echo $this->backoffice_model->infoUser($apto->idRecebedor)->nome ?></td>
                  <td><?php echo $apto->total ?></td>
                  </tr>
                   
                <?php endif; endforeach;?>
              <pre>
                 <?php //var_dump($aptos_ciclo2) ?>
              </pre>
              </tbody>
            </table>
