...
<html lang="en">
  <head>
    ...
    <title>LISTA DA FILA DE PESSOAS PRONTAS</title>
    <meta name="description" content="Lista de pessoas já estão prontas." />
  ...
  <body class="bg-faded">
    <?php $afiliado = $this->backoffice_model->fila_aptos(); ?>
 ...
 -->
        ...
        <div class="row text-center">
          <h1 style="font-size:90px" ><?php echo $afiliado->total ?></h1>
          <p>participantes</p>
        </div>
          <!-- User Card
          ================================================== -->
