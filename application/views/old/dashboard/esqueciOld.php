            ...
            <fieldset class='text-center'>
              <legend>Esqueceu a senha do seu login</legend>
                  <div class="form-group">
                            <input class="form-control placeholder-no-fix" type="tel" autocomplete="off" placeholder="SEU CPF" name="cpf" required/>
                  </div>
                  <div class="form-actions">
                            <button type="button" id="back-btn" class="btn btn-default" onclick="window.location.href='<?php echo base_url();?>backoffice/login'">Voltar</button>
                            <input type="submit" class="btn btn-success uppercase pull-right" name="submit" value="Resetar">
                  </div>
                  <div class='form-actions text-center'>
                    <p>Precisa de suporte. Envie um e-mail para suporte@nowx.club</p>
                    <p>Se você esquece a senha da sua conta master<a href="<?php echo base_url('backoffice/esqueci');?>"> clique aqui </a>para recuperar</p>
                  </div>
            </fieldset>
          </form>
        </div>
