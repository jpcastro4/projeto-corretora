        ...
        <div class="col-12 col-md-10  bg-grey-md1 height-100">
            <div class="row align-items-center head header-contain pd-20">
                    ...
                    <div class="col-sm-4 ">
                        <!-- <h1 class="title title-2 text-center"> Novo post </h1> -->
                    </div>
            ...
            <div class="row">
                <div class="contain-container ">
                    <div class="col-12 col-lg-12 pd-10">
                        <div class="hightlight-alert"> Escolha um item no menu </div>
                    </div>                   
                </div>
            </div>
