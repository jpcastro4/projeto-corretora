                        ...
                        <div class="contain-card px-2 py-3 block-md">
                            ...
                            <form action="" method="post" >
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" name="usuarioNome" class="form-control " value="<?php echo $usuario->usuarioNome ?>" placeholder="Nome" required />
                                    </div>
                                    <div class="form-group col-xs-12">
                                    <input type="text" name="usuarioEmail" class="form-control " value="<?php echo $usuario->usuarioEmail ?>" placeholder="E-mail" required />
                                    </div>
                                    <div class="form-group col-xs-12">
                                    <input type="text" name="usuarioSenha" class="form-control " placeholder="Senha" />
                                    </div>
                                </fieldset>
                                <input type="hidden" name="form" value="editar-usuario" required />
                            </form>
